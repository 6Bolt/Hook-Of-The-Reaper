#ifndef ADDLIGHTGUNWINDOWV2_H
#define ADDLIGHTGUNWINDOWV2_H
...
namespace Ui {
class addLightGunWindowV2;
}

class addLightGunWindowV2 : public QDialog
{
    Q_OBJECT

public:
    explicit addLightGunWindowV2(ComDeviceList *cdList, QWidget *parent = nullptr);
    ~addLightGunWindowV2();
